...
class _Scan_ProductState extends StateMVC<Scan_Product> {
  ShoppingList_Controller _con;

  _Scan_ProductState() : super (ShoppingList_Controller()){
    _con = controller;
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Center(child: Text(S.of(context).scan_product)),
      ),
    );
  }
}
