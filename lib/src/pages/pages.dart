...
import 'package:food_delivery_app/src/pages/location.dart';
...
class _PagesTestWidgetState extends StateMVC<PagesTestWidget> {
  ProfileController _con;

  _PagesTestWidgetState() : super(ProfileController()) {
    _con = controller;
  }
  ...
  void _selectTab(int tabItem) {
    setState(() {
      ...
      switch (tabItem) {
        ...
        case 1:
          widget.currentPage =
              LocationWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
        case 2:
          widget.currentPage =
